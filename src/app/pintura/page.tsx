...
import PinturaJsonLd from "@/components/PinturaJsonLd";
import {
  pinturaMeta,
  pinturaUrl,
  procesoPintura,
...
export const metadata: Metadata = {
  title: pinturaMeta.title,
  description: pinturaMeta.description,
  keywords: [...pinturaMeta.keywords],
  alternates: {
    canonical: pinturaUrl,
  },
  openGraph: {
    title: `${pinturaMeta.title} | ${siteConfig.name}`,
    description: pinturaMeta.description,
    url: pinturaUrl,
    type: "website",
          ...
          <div className="max-w-7xl mx-auto">
            <nav aria-label="Breadcrumb" className="mb-8">
              <ol className="flex items-center gap-2 text-xs uppercase tracking-widest text-[#8C8C8C]">
                ...
                <li className="text-[#BF1725] font-bold">Pintura</li>
              </ol>
            </nav>
            ...
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black uppercase leading-[0.95] tracking-tighter text-[#0D0D0D] mb-8">
                Pintura
                <span className="block text-[#BF1725]">Automotriz</span>
              </h1>

              <p className="text-[#8C8C8C] text-lg md:text-xl leading-relaxed font-light mb-10">
                Cabina de pintura profesional con mezclas computarizadas para coincidir
                exactamente con el color original del fabricante. Repintado total, parcial
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {serviciosPintura.map((servicio) => (
                ...
                >
                  <div className="text-4xl mb-6">{servicio.icon}</div>
                  <h3 className="text-gray-900 font-black text-lg uppercase tracking-wide mb-3 group-hover:text-[#BF1725] transition-colors">
                    {servicio.title}
                  </h3>
                  <p className="text-gray-500 text-sm leading-relaxed">{servicio.description}</p>
                </article>
              ))}
            </div>
          </div>
        ...
        <section className="py-24 px-6 bg-[#0D0D0D]">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-[#8C8C8C] text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
              ¿Necesitas repintar tu vehículo o corregir daños en la carrocería? Escríbenos
              y recibe una cotización con el color exacto de fábrica.
            </p>
