...
import ImportacionesJsonLd from "@/components/ImportacionesJsonLd";
import {
  importacionesMeta,
  importacionesUrl,
  incluyeImportacion,
...
export const metadata: Metadata = {
  title: importacionesMeta.title,
  description: importacionesMeta.description,
  keywords: [...importacionesMeta.keywords],
  alternates: {
    canonical: importacionesUrl,
  },
  openGraph: {
    title: `${importacionesMeta.title} | ${siteConfig.name}`,
    description: importacionesMeta.description,
          ...
          <div className="max-w-7xl mx-auto">
            <nav aria-label="Breadcrumb" className="mb-8">
              <ol className="flex items-center gap-2 text-xs uppercase tracking-widest text-[#8C8C8C]">
                ...
                <li className="text-[#BF1725] font-bold">Importaciones</li>
              </ol>
            </nav>
            ...
            <div className="max-w-3xl">
              <div className="mb-6 flex items-center gap-4">
                ...
                <p className="text-[#BF1725] text-xs md:text-sm font-bold uppercase tracking-[0.4em]">
                  Tu vehículo, sin complicaciones
                </p>
              </div>
              ...
              <p className="text-[#8C8C8C] text-lg md:text-xl leading-relaxed font-light mb-10">
                Importamos vehículos directamente con documentación completa, verificación
                técnica y trámites aduaneros incluidos. Desde la selección hasta la entrega
                en Asunción, te acompañamos en cada paso.
              </p>
        ...
        <section className="py-24 px-6 bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {procesoImportacion.map((paso) => (
                <article
                  key={paso.step}
                  className="group border border-gray-200 rounded-lg p-8 hover:border-[#BF1725] transition-all duration-300 hover:shadow-lg"
                >
        ...
        <section className="py-24 px-6 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {incluyeImportacion.map((item) => (
                <div
                  key={item.title}
                  className="bg-white rounded-lg p-8 border border-gray-200 hover:border-[#BF1725] transition-all duration-300"
                >
                  <h3 className="text-gray-900 font-black text-base uppercase tracking-wide mb-3">
                    {item.title}
                  </h3>
        ...
        <section className="py-24 px-6 bg-[#0D0D0D]">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-[#8C8C8C] text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
              ¿Quieres importar un vehículo o necesitas asesoría sobre el proceso? Escríbenos
              y te respondemos con una cotización detallada.
            </p>
